...
from bot.handlers.agent import start_agent, cancel_agent, agent_text, agent_photo, agent_review_callback
...
def create_bot_app():
    ...
    app.add_handler(CallbackQueryHandler(agent_review_callback, pattern=r"^agent:"))
